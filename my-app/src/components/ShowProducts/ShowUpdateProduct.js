...
export default function ShowUpdateProduct({
  handleSubmit,
}) {
      ...
      <form className="new-product-form" onSubmit={handleSubmit}>
        <section className="nnnn">
          ...
          <article className="product-categori">
            ...
            <select name="category_id"    value={productData.category_id} onChange={handleChange}>
          ...
          <article className="more-product-info">
            ...
            <div className="product-more-info-input-wrapper">
              ...
              <select name="connection_type" value={productData.connection_type} onChange={handleChange}>
                <option selected disabled>
                  Anslutningtyp
                </option>
            ...
            <div className="product-more-info-input-wrapper">
              ...
              <select name="charging_time" value={productData.charging_time} onChange={handleChange}>
                <option selected disabled>
                  Laddningstid
                </option>
            ...
            <div className="product-more-info-input-wrapper">
              ...
              <select name="battery_life" value={productData.battery_life} onChange={handleChange}>
                <option selected disabled>
                  Batteritid
                </option>
            ...
            <div className="product-more-info-input-wrapper">
              ...
              <select name="garanti" value={productData.garanti} onChange={handleChange}>
                <option selected disabled>
                  Garanti
                </option>
            ...
            {productData.img ? (
              <>
                <div className="uploaded-img">
                  <img src={productData.img} alt="Förhandsvisning" />
                </div>
              </>
            ) : (
